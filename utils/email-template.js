const getTemplateHTML = (url) => {
    ...
    */
    ...
    <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Confirm Email for Chesso account.
    </div>
    <!-- end preheader -->
    <!-- start body -->
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <td align="center" bgcolor="#e9ecef">
            ...
            <tr>
                ...
                <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;"> <img src="cid:chesso.png" alt="placeholder" width="45" height="45" >Confirm Your Email Address</h1>
                </td>
            </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
        ...
        <td align="center" bgcolor="#e9ecef">
            ...
            <tr>
                ...
                <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account for <a href="${url.slice(0,url.indexOf('verify'))}">Chesso online multiplayer chess</a>, you can safely delete this email.</p>
                </td>
            </tr>
            <!-- end copy -->
            <!-- start button -->
            ...
            <tr>
                ...
                <p style="margin: 0;">Cheers,<br> Chesso</p>
                </td>
            </tr>
            <!-- end copy -->
            </table>
